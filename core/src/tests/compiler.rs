use crate::{
    compiler::{compiler::Compiler, constant::Constant, instruction::Instruction},
    lexer::lexer::Lexer,
    parser::{parser::Parser, statement::Statement},
};
...
fn variable_declaration_with_expression() {
    let source = concat!("let result = (20 + 30) / 2;");
