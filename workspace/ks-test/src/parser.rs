...
fn test_assigment_statement() {
    let source = concat!("let a = \"Hey Hey\";\n", "a = \"Hello World\";\n",);

    let test_statement = Statement::Assignment {
        segments: vec![IdentifierTail::Name(String::from("a"))],
...
fn test_function_call_statement() {
    ...
    let test_expression = Expression::FunctionCall(
        String::from("print"),
        vec![
...
fn test_parser_string_index_1() {
    ...
    let test_expression = Expression::ListIndex {
        left: Box::new(Expression::StringLiteral(String::from(
            "Hello worlda asdasd asd",
        ))),
        index: Box::new(Expression::IntegerLiteral(10)),
    };
...
fn test_parser_tuple() {
    let test_expression = Expression::TupleLiteral(vec![
        Expression::IntegerLiteral(10),
...
fn test_parser_callback() {
    let source = concat!("let test = function() {};\n",);
    ...
    let test_statement = Statement::VariableDeclaration {
        ...
        value: Some(Expression::FunctionLiteral {
            ...
            block: vec![Statement::ReturnStatement {
                value: Some(Expression::IntegerLiteral(32)),
            }],
        }),
    };
